...
## Project Structure
    ...
    ├── testapiautoteammemb_96125  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_96125`
...
2. Clone this repo and `cd testapiautoteammemb_96125`
